...
import com.project.apature.service.BookmarkService;
...
public class BookmarkController {
    ...
    @Operation(description = "테마별 인기 장소 즐겨찾기", method = "POST")
    ...
    @Operation(description = "테마별 인기 장소 즐겨찾기 해제", method = "DELETE")
    ...
    @Operation(description = "테마별 인기 장소 즐겨찾기 여부 확인", method = "GET")
    ...
    @Operation(description = "근처 장소 즐겨찾기", method = "POST")
    ...
    @Operation(description = "근처 장소 즐겨찾기 해제", method = "DELETE")
    ...
    @Operation(description = "근처 장소 즐겨찾기 여부 확인", method = "GET")
