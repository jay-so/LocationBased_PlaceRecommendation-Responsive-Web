...
class PopularControllerTest {
    ...
    @Test
    @Order(1)
    public void 테마별_추천장소_리스트_조회() throws Exception {
    ...
    @Test
    @Order(2)
    public void 테마별_추천장소_상세_조회() throws Exception {
        contentId = 1920563L;
    ...
    @Test
    @Order(3)
    public void 테마별_추천장소_가족_필터() throws Exception {
        PopularDto popularDto = new PopularDto();
        popularDto.setQuantity("20");
        popularDto.setCat1("C01");
        popularDto.setCat2("C0112");
    ...
    @Test
    @Order(4)
    public void 테마별_추천장소_나홀로_필터() throws Exception {
        PopularDto popularDto = new PopularDto();
        popularDto.setQuantity("20");
        popularDto.setCat1("C01");
    ...
    @Test
    @Order(5)
    public void 테마별_추천장소_힐링_필터() throws Exception {
        PopularDto popularDto = new PopularDto();
        popularDto.setQuantity("20");
        popularDto.setCat1("C01");
    ...
    @Test
    @Order(6)
    public void 테마별_추천장소_걷기좋은_필터() throws Exception {
        PopularDto popularDto = new PopularDto();
        popularDto.setQuantity("20");
        popularDto.setCat1("C01");
    ...
    @Test
    @Order(7)
    public void 테마별_추천장소_캠핑_필터() throws Exception {
        PopularDto popularDto = new PopularDto();
        popularDto.setQuantity("20");
        popularDto.setCat1("C01");
    ...
    @Test
    @Order(8)
    public void 테마별_추천장소_맛집_필터() throws Exception {
        PopularDto popularDto = new PopularDto();
        popularDto.setQuantity("20");
        popularDto.setCat1("C01");
    ...
    @Test
    @Order(9)
    public void 테마별_추천장소_장소별_날씨() throws Exception {
