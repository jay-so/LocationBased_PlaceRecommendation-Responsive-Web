...
import com.project.apature.service.UserService;
...
class BookmarkControllerTest {
    ...
    @Test
    @DisplayName("테마별 추천장소 북마크 상태(False)")
    @WithUserDetails(value = "testId")
    @Order(3)
    ...
    @Test
    @DisplayName("테마별 추천장소 북마크 상태(True)")
    @WithUserDetails(value = "testId")
    @Order(4)
    ...
    @Test
    @DisplayName("근처 장소 북마크 상태(False)")
    @WithUserDetails(value = "testId")
    @Order(7)
